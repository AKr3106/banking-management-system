...
<nav class="navbar navbar-expand-lg navbar-dark ">
    ...
    <div class="welcome">Customer Data Search</div>
    <div class="container">
...
<input type="text" value=<?php echo $customer['id'] ?> readonly>

<label>Customer Name</label>
<input type="text" value=<?php echo $customer['cname'] ?> readonly>

<label>Phone No.</label>
<input type="text" value=<?php echo $customer['phone'] ?> readonly>

<label>Balance</label>
<input type="text" value=<?php echo $customer['balance'] ?> readonly>
